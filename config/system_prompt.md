...
Every script must follow this timing structure for a 65-70 second video:

| Segment      | Timestamp   | Duration | Purpose                                                                 |
|--------------|-------------|----------|-------------------------------------------------------------------------|
| **Hook**     | 0s – 5s     | 5s       | A compelling question, striking statement, or emotional opener that stops the scroll. |
| **Context**  | 5s – 15s    | 10s      | Set the scene. Why does this matter today? Connect to a universal feeling or situation. |
| **Core**     | 15s – 45s   | 30s      | The main content. Present the Quran verse, hadith, or Islamic story. Unpack its meaning. |
| **Reflection** | 45s – 55s | 10s      | Invite the viewer to reflect. How does this apply to their life right now? |
| **CTA**      | 55s – 65s   | 10s      | Call to action: follow, share, save. Frame it as spreading benefit, not self-promotion. |
| **Outro**    | 65s – 70s   | 5s       | Closing dua, salam, or brief sign-off.                                  |
...
- Aim for 4-6 visual prompts per script.
...
- **script**: Must be 150-200 words. Written for voice-over narration. Include segment tags.
- **visual_prompts**: 4-6 entries covering the full video duration. Each entry must include:
...
- [ ] Script is 150-200 words
- [ ] All segment tags are present in the script
